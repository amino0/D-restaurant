...
<head>
    ...
    <title>Admin - Employer | CORK</title>
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <button type="button"  class="btn btn-warning mb-2 mr-2 fadeInUp" data-toggle="modal" data-target="#slideupModal" style="float: right; background-color:blue">Ouvrir une Caisse</button>
                            @if(session('success'))
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                ...
                                <table id="alter_pagination" class="table table-hover" style="width:100%">
                                    ...
                                    @foreach ($caisse as $row)
                                        ...
                                        <tr>
                                            <td>{{$row->id}}</td>
                                            <td>{{$row->date_ouvert}}</td>
                                            <td>{{$row->date_fermer}}</td>

                                            <td class="text-center">
                                                <form action="{{url("/administrateur/fermercaisse")}}" method="POST">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{$row->id}}">

                                                @php
                                                if($row->date_fermer == null){
                                                    echo "
                                                    
                                                    
                                                             <button type='submit' class='btn btn-outline-danger'>Fermer La journner </button>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="POST" action="{{url('/administrateur/ouvrircaisse')}}">
                                    @csrf
                            ...
                            <div class="modal-footer md-button">
                                <button class="btn" data-dismiss="modal"><i class="flaticon-edit-12"></i> Fermer</button>
                                <button type="submit" class="btn btn-outline-danger">Ouvrir</button>
                            </form>
                            </div>
                        </div>
                    </div>
