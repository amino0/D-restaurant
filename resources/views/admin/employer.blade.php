                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Employer Ajout</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <form>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Saisir le Nom de l'employer">
                                        </div>
                                        <div class="col">
                                            <input type="number" class="form-control" placeholder="Salaire de l'employer">
                                        </div>
                                      
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Fonction employer</label>
