...
<head>
    ...
    <title>CORK Admin Template - Order Sorting DataTables</title>
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{url('/administrateur')}}"><img alt="logo" src="{{asset('template/admin.png')}}"> <span class="navbar-brand-name">Administration</span></a>
            </div>
            ...
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu active">
                        <a href="{{url('/administrateur/menu')}}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu single-menu">
                        <a href="{{url('/administrateur/caisse')}}" class="dropdown-toggle">
                            <div class="">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <button type="button"  class="btn btn-warning mb-2 mr-2 fadeInUp" data-toggle="modal" data-target="#slideupModal" style="float: right; background-color:blue">Ajouter d'une Categorie</button>
                                    ...
                                    <tbody>
                                      @foreach ($categories as $row )
                                        <tr>
                                            ...
                                            <td>{{$row->id}}DJ/2021</td>
                                            <td><a href="{{url("/administrateur/activemenu/$row->id")}}" class="btn btn-danger" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cloud-lightning"><path d="M19 16.9A5 5 0 0 0 18 7h-1.26a8 8 0 1 0-11.62 9"></path><polyline points="13 11 9 17 15 17 11 23"></polyline></svg></a>
                                                <a href="{{url("/administrateur/desactivemenu/$row->id")}}" class="btn btn-warning" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cloud-off"><path d="M22.61 16.95A5 5 0 0 0 18 10h-1.26a8 8 0 0 0-7.05-6M5 5a8 8 0 0 0 4 15h9a5 5 0 0 0 1.7-.3"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg></a>
                                                <a href="{{url("/administrateur/deletecategorie/$row->id")}}" class="btn btn-info" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a></td>
                                        <td><a href="{{"/administrateur/categorie/$row->id"}}" class="btn btn-primary" > Ajouter</a></td>
                                            </tr>
                                        @endforeach 
                                    </tbody>
                                    <tfoot>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Employer d'une categorie</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <form method="POST" action="{{url('/administrateur/new_categorie')}}">
                                    @csrf
                                    <div class="form-group">
                                      ...
                                      <input type="hidden" name="idmenu" value="{{request()->route('id')}}">
                                    
                                     
                                
                            </div>
                            <div class="modal-footer md-button">
                                <button class="btn" data-dismiss="modal"><i class="flaticon-edit-12"></i> Discard</button>
