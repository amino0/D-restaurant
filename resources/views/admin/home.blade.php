            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Tableau de bord de Vente</h3>
                    </div>
                        ...
                        <div class="widget-two">
                            <div class="widget-content">
                                <div class="w-numeric-value">
                                    <div class="w-content">
                                        <span class="w-value">Vente par semaine</span>
                                        <span class="w-numeric-title">De vendredi à jeudi </span>
                                    </div>
                                    <div class="w-icon">
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th><div class="th-content">Serveuse</div></th>
                                                <th><div class="th-content">Produit</div></th>
                                                <th><div class="th-content th-heading">Prix</div></th>
                                                <th><div class="th-content">Status</div></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($commandess as $row)   
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{asset('template/assets/img/90x90.jpg')}}" alt="avatar">Neima</div></td>
                                                <td><div class="td-content">{{$row->article}}</div></td>
                                                <td><div class="td-content pricing"><span class="">{{$row->prix_vendu}} DJF</span>  </div></td>
                                                <td><div class="td-content">
                                                    @php
                                                      
                                                            echo "<span class='badge outline-badge-warning'>Article Vendu</span>";
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><div class="th-content">Classement</div></th>
                                                <th><div class="th-content">Serveur</div></th>
                                                <th><div class="th-content">Produit</div></th>
                                        ...
                                        <tbody>
                                            ...
                                            $i = 1;
                                        @endphp
                                          @foreach ($commandebest as $row )
                                              
                                          
                                            <tr>
                                                <td><div class="td-content"><span class="pricing">{{$i}} iem </span></div></td>
                                                <td><div class="td-content product-name"><img src="{{asset('template/assets/img/90x90.jpg')}}" alt="product"></div></td>
                                                <td><div class="td-content"><span class="pricing">{{$row->article}}</span></div></td>
